...
async def finance_modeler_node(state: FinanceState) -> FinanceState:
    logger.log_node_start("Finance Modeler", "Synthesizing unit economics and FinancialPlan...")
    ...
    if critic_feedback:
        ...
        logger.log_node_start("Finance Modeler", "Refining financial plan based on critic feedback...")
